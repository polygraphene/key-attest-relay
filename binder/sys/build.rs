...
fn main() {
    ...
    let bindings = bindgen::Builder::default()
        ...
        .clang_arg("-I")
        .clang_arg(source.to_string() + "/frameworks/native/libs/binder/ndk/include_platform")
        .clang_arg("-I")
        .clang_arg(sysroot.join("usr/include").display().to_string())
        .clang_arg("-I")
        .clang_arg(sysroot.join("usr/include/aarch64-linux-android").display().to_string())
        .clang_arg("-I")
