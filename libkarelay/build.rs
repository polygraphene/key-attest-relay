...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    cxx_build::bridge("src/lib.rs")
        ...
        .include(source.to_string() + "/system/security/keystore/include")
        .compile("libkarelay");
    ...
    println!("cargo::rustc-link-arg={source}/out/target/product/generic_arm64/system/lib64/libkeystore-attestation-application-id.so");
    ...
    println!("cargo:rerun-if-changed=src/appid.cc");
    println!("cargo:rerun-if-changed=include/appid.h");
    Ok(())
}
